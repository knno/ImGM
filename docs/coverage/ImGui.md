...
| `ImGui.GetFontSize` | ✅ | [imgui_fonts_gm.cpp](https://github.com/knno/ImGM/blob/main/src/dll/imgui/wrappers/imgui_fonts_gm.cpp#L84) | - |
| `ImGui.GetFontBaked` | ❌ | - | - |
...
|---------|------------------|------|
| `ImGui.AddFontDefault` | [imgui_fonts_gm.cpp](https://github.com/knno/ImGM/blob/main/src/dll/imgui/wrappers/imgui_fonts_gm.cpp#L70) | - |
